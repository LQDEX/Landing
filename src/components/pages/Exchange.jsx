...
import { exchangeStyle } from './styles';
...
class Exchange extends Component {
  ...
  render() {
    ...
    return (
      <div className={style} >
        <h1 style={{ fontSize: '4em' }}>EXCHANGE PAGE</h1>
...
export default connect(stateToProps, dispatchToProps)(injectSheet(exchangeStyle)(Exchange));
